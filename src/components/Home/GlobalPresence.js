...
//   ];
//   return (
//     <section className="w-100" style={{ padding: "40px 0" }}>
...
//                 <img key={`global-presence-${key}`} src={ele} />
//               </div>
//             </SwiperSlide>
//           );
//         })}
...
const BrandCarousel = () => {
  ...
  return (
    <section className="brand-carousel overflow-hidden position-relative w-100">
